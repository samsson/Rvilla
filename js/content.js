...
const HOUSE = {
    ...
    prevLabel: 'Edellinen',
    nextLabel: 'Seuraava',
    themeLightLabel: 'Vaalea teema',
    themeDarkLabel: 'Tumma teema',
...
const SECTIONS = [
  ...
  },
  {
    ...
    body: {
        ...
        { type: 'p', text: 'Lähin kierrätyspiste löytyy osoitteesta: Loutinkatu 59' },
        { type: 'p', text: 'Muut ekopisteet löydät rinkiin sivuilta <a href="https://rinkiin.fi/lajittelu-kotona/ekopisteet" target="_blank" rel="noopener">rinkiin.fi</a>.' },
      ...
      en: [
        ...
        { type: 'p', text: 'Closest recycling center is in: Loutinkatu 59' },
        { type: 'p', text: 'Find other recycling points at <a href="https://rinkiin.fi/lajittelu-kotona/ekopisteet" target="_blank" rel="noopener">rinkiin.fi</a>.' },
